  ...
  return (
    <div className="about-container">
      ...
      <header className="about-hero">
        <h1>Welcome HealthCare Wellness Center Hospital</h1>
      ...
      <section className="about-intro">
        <h2>Who We Are</h2>
        <p>
        HealthCare Wellness Center Hospital is a world-class medical institution dedicated to providing
      ...
      <section className="about-why">
        <h2>Why Choose HealthCare Wellness Center Hospital?</h2>
